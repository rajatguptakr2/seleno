                    ...
                    <div class="container admin_form_body">
                        ...
                        <div class="col-lg-12 well">
                            <div class="row"> 
                                ...
                                <form method="POST" action="<?php $uri = uri_segment(3); echo base_url("submenu/update/{$uri}")?>" class="loginSubmit">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <select class="form-control" name="menu_id">
                                                ...
                                                <option value="<?php echo $men->menu_id?>" <?php if($view->menu_id == $men->menu_id){echo 'selected';}?>><?=$men->menu_name?></option>
                                               <?php endforeach;?>
                                            ...
                                            <div class="col-sm-12 form-group">
                                                ...
                                                <input type="text" name="submenu_name" value="<?php echo $view->submenu_name; ?>" placeholder="Enter Menu Name Here.." class="form-control">
                                            ...
                                            <select class="form-control" name="submenu_status">
                                                <option value="active" <?php if($view->submenu_status == 'active'){ echo 'selected';}?>>Active</option>
                                                <option value="inactive" <?php if($view->submenu_status == 'inactive'){ echo 'selected';}?>>Inactive</option>
